...
-- Insert correct admin user (password: admin123)
INSERT INTO admin_users (username, password_hash, role)
VALUES ('admin', '$2a$10$0HQwTfVQB5RBBuG3IgdD9OgAzGlF7FLa1yXmgAqiW1EdqvUUn0Af.', 'super_admin');

-- Sample teachers with correct password hashes
...
('12345678901', 'Mehmet', 'Yılmaz', '1985-05-15', 85.50, 'Matematik', 'Ankara Atatürk İlkokulu', '$2a$10$h5F6wBlZxoFVwQwkGoEPvebz2Q4KK0lkaVcORsKoVpJISuenoB.Oq'),
('12345678902', 'Ayşe', 'Demir', '1982-03-22', 92.75, 'Türkçe', 'İstanbul Fatih Ortaokulu', '$2a$10$BykFr6hmoJx8Zc3k0ukvIeXL3XxPmBxRXNDlMTFpejkj/WLTczoMC'),
('12345678903', 'Ali', 'Kaya', '1988-11-08', 78.25, 'Fen Bilgisi', 'İzmir Konak Lisesi', '$2a$10$MYCb5BrqhupLgzgTXqL8HeRkR1MlZMf.7rQ1KgnVtlaUe2PPUDWda');
